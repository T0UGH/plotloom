...
def _updated_receipt(
    *,
    ...
    return Receipt(
        ...
        source_prompt_sha256=str(receipt_data.get("source_prompt_sha256")) if receipt_data.get("source_prompt_sha256") else None,
        ...
        qa_checklist=list(receipt_data.get("qa_checklist") or []),
        cost=dict(receipt_data.get("cost") or {}),
        timing=dict(receipt_data.get("timing") or {}),
        selection=dict(receipt_data.get("selection") or {}),
